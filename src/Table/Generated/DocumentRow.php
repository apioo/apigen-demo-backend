...
class DocumentRow implements \JsonSerializable, \PSX\Record\RecordableInterface
{
    private ?int $id = null;
    ...
    {
        return $this->authorId ?? throw new \PSX\Sql\Exception\NoValueAvailable('No value for required column "author_id" was provided');
    }
    ...
    public static function from(array|\ArrayAccess $data): self
    {
        ...
        $row->authorId = isset($data['author_id']) && is_int($data['author_id']) ? $data['author_id'] : null;
